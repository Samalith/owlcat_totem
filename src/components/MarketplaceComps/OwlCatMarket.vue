<template>
  <div class="totem-scaled">
    <div class="totem-item">
      <div class="totem-item__image">
        <!-- ********* OwlCat Image *********** -->
        <div class="cat">
          <div
            class="head-cat"
